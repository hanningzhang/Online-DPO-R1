...
output_dir = "selfcorrexp2/llama3_openmath_em_ep1_tmp07_with_balanced_orm_rewards"
def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--reward_name_or_path", type=str, default='HanningZhang/Llama3-sft-balanced-rr60k-orm')  # model path
    parser.add_argument("--dataset", type=str, default='selfcorrexp2/llama3_openmath_em_ep1_tmp07')  # data path
    parser.add_argument("--output_dir", type=str, default="selfcorrexp2/llama3_openmath_em_ep1_tmp07_with_balanced_orm_rewards")  # output dir
...
if __name__ == "__main__":
    ...
    #print(world_size)
    ds = load_dataset(args.dataset,split="train")#.select(range(1319*2))
    ...
    gathered_save_data = new_data
    keys = gathered_save_data[0].keys()  
    
    dict_data = {key: [d[key] for d in gathered_save_data] for key in keys}
